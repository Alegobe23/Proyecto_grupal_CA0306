...
Deacuerdo con lo expuesto en la sección de metodología apartado "Primas". Se calcularon las primas por grupo de edad y sexo para empleados activos y obtuvieron los siguientes resultados:
 ```{=latex}
\begin{center}
```
...
Empleando el método correpondiente, se cálculo la prima media general para toda la población y se obtuvo el siguiente resultado:
...
Donde la columna de VPA del total de los costos representa el valor actuarial de los costos totales cálculados para el plan de beneficios, mientras que el apartado de VP Esperado de la Masa Salarial usa el procedimiento descrito en la sección de metodología apartado
