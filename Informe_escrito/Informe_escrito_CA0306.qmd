...
## Comparación entre los empleados activos y los empleados pensionados
...
## Proyección demográfica y de muertes de los empleados activos
...
Donde $J\_{i,t}$ representa la salida esperada por jubilación. De esta forma, la transición anual de los empleados activos se resumió mediante la relación entre los empleados activos al inicio, las muertes esperadas, las jubilaciones esperadas y los empleados activos al cierre.
...
## Proyección demográfica y proyección de muertes de los empleados pensionados
...
Esta expresión corresponde a la forma discreta usual $({}_kp_x q_{x+k})$, adaptada a una tabla dinámica de mortalidad.
...
$$
{}_{t-1}p_{x_j}^{(s_j,y_0)}
q_{x_j+t-1}^{(s_j,y_0+t-1)}
$$
...
$$
FE^{A}{j,t}=B_A \cdot {}_{t-1}p_{x_j}q_{x_j+t-1},
$$
...
$$
{}_{t_i}p_{x_i}^{(s_i,y_0)}=\prod_{j=0}^{t_i-1}
\left(1-q_{x_i+j}^{(s_i,y_0+j)}\right),
$$
...
Resulta relevante notar que, aunque el flujo de los pensionados actuales inicia antes en el tiempo, su peso dentro del costo total del plan es comparativamente bajo: representan apenas el 2,35 % del costo nominal y el 16,69 % del costo actuarial total, mientras que los empleados activos concentran el 97,65 % del costo nominal y el 83,31 % del costo actuarial. Esta diferencia se explica porque la cohorte de pensionados actuales es relativamente pequeña y se extingue antes (alrededor de 2083), mientras que los activos constituyen un grupo más numeroso cuyos beneficios, una vez jubilados, se proyectan sobre un horizonte considerablemente más largo (hasta 2119), además de beneficiarse del crecimiento salarial acumulado previo a la jubilación.
...
*Costo nominal y actuarial esperado de las anualidades de pensión, desglosado por tipo de participante*
...
Finalmente, al integrar todos los beneficios analizados, se obtuvo un costo nominal esperado total de ₡435.187.867.585,83 El costo actuarial total a valor presente fue de ₡29.963.897.507,40. Este valor representa la estimación global del compromiso económico del plan, considerando los beneficios por muerte de activos, muerte de pensionados, anualidades de pensión y suma única de reconocimiento.
...
Viendo los resultados de las primas podemos señalar varios aspectos:

Lo primero que se observa es una tendencia al crecimiento conforme aumenta la edad del grupo. Esto no debe sorprender, ya que a mayor edad se integran menos salarios anuales a la masa salarial; en consecuencia, el denominador de la fracción decrece. Existen algunas excepciones, como el grupo masculino conformado por un hombre de 62 años y el femenino por una mujer de 58 años. Estas primas son de hecho las más bajas, pues ambos presentan una edad elevada y una antigüedad muy baja (menor a 10 años), lo que los deja sin derecho a pensión.

También se aprecia que, en general, las mujeres de la misma edad que los hombres tienen una prima más alta. Esto puede deberse a varios factores: por un lado, al tener una edad de jubilación más temprana, reciben en promedio más beneficios de pensión durante su vida jubilada. Además, según la tabla SP‑2015, la mortalidad femenina es menor que la masculina, lo que implica que los beneficios de pensión o el Lump Sum pesan más en proporción, ya que las mujeres tienen mayor probabilidad de alcanzar edades avanzadas. Asimismo, factores externos al sexo, como la antigüedad promedio, el número de miembros y los niveles salariales, pueden generar variaciones en los costos y en la masa salarial, y por ende en las primas.

Las brechas en las primas se hacen más notorias a partir de los 41 años. Al analizar detalladamente los números, se observa una tendencia a un mayor cambio negativo en la masa salarial que en los costos. Esto significa que, en las mujeres, los costos cambian menos en proporción que la masa salarial, lo que provoca que la razón de la prima se incremente proporcionalmente más. La explicación radica en que en las mujeres la edad de jubilación es más temprana (63 años frente a 65 en los hombres). Al retirarse antes, la masa salarial esperada de las mujeres suman menos años de aportes, lo que reduce el denominador, que hace que en edades más avanzadas, al disponer de menos años restantes de trabajo, el diferimiento en los salarios recibidos tenga un mayor efecto en la prima resultante en comparación con la de los hombres.

Finalmente, al analizar los valores extremos de las primas encontramos dos situaciones:

1) En el mínimo, el valor 0,0 corresponde a grupos de personas de un sexo y edad en los que no existen trabajadores activos. Excluyendo este caso trivial, los valores más bajos para grupos existentes son 0,03 y 0,04, correspondientes a las personas mencionadas en el primer párrafo.
2) En el extremo superior aparecen valores pico como 1,50 y 1,45. Estos corresponden a casos especiales de grupos de una sola persona, mujeres de 54 y 56 años respectivamente, que están próximas al retiro y cuentan con una antigüedad elevada a pocos años de la fecha de corte. En estos casos, el factor de descuento aplicado a los primeros años de pensión o al pago del Lump Sum no reduce tanto el valor al traerlo a presente, lo que explica las primas tan altas.
...
|----------------------------|-----------------------------|---------------|
| ₡29 963 897 507,40 | ₡67 646 592 226,38 | 0,44 |
...
Observe que resultado de esta prima no es más que el promedio aproximado de los valores de las primas de los grupos de edad y sexo.
...
### Anualidades de la pensión por vejez
...
En diagonal, los razonamientos son los mismos que para el Lump Sum, pero las diferencias son más amplias: de izquierda a derecha, las variaciones son menores en magnitud, aunque proporcionalmente más altas que en el Lump Sum; mientras que de derecha a izquierda, las diferencias son más significativas y se alejan más del valor original. Esto se explica porque en el Lump Sum el descuento se aplica una sola vez, mientras que en las anualidades se aplica cada año sobre cada flujo, amplificando el efecto.
...
En síntesis la comparación de las tres etapas de desarollo evidencia que la identificación de los beneficios con mayor incidencia sobre el costo actuarial constituye un elemento fundamental para la toma de decisiones. Asimismo, se reafirma la importancia de estudiar la sensibilidad de los elementos bajo estudio respecto a los diversos supuestos financieros, ya que esto permite identificar los aspectos que podrían disparar los costos actuariales asociados a los beneficios otorgados, en consecuencia, las decisiones tomadas en torno a la reducción de costos podrían realizarse desde un mayor conocimiento.
...
-   Si bien se reconoce la necesidad de procurar la sostenibilidad financiera de las empresas aseguradoras, se recomienda que cualquier estrategia orientada a la reducción de costos mantenga un equilibrio entre el rubro mencionado y la protección de los derechos e intereses de la población beneficiaria. Pese a que es requerido adoptar una perspectiva empresarial que promueva el uso eficiente de los recursos, también es indispensable reconocer que las medidas de ajuste recaen sobre beneficios de gran relevancia para las personas, tales como la pensión por vejez, el seguro de vida y otros mecanismos de protección.
