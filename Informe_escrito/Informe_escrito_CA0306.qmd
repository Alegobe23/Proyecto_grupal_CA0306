...
Donde (D\_{i,t}) representa las muertes esperadas del empleado (i) en el año (t), (L\_{i,t}) representa la probabilidad de que el empleado permanezca activo al inicio del año y (q\_{x_i}) corresponde a la probabilidad inicial de muerte obtenida de la tabla SP-2015.
...
Donde (J\_{i,t}) representa la salida esperada por jubilación. De esta forma, la transición anual de empleados activos se resumió mediante la relación entre activos al inicio, muertes esperadas, jubilaciones esperadas y activos al cierre.
...
| **Beneficio** | **Costo actuarial inicial** | **Costo actuarial actualizado** |
| *Total* | ₡29 672 788 161.99 | ₡26 676 396 788.69 |
