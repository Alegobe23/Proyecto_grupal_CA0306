...
Para el análisis de sensibilidad de las tasas, se calcularon los costos totales nominales (i.e., la suma de los flujos anuales esperados brutos) y el valor presente actuarial de los costos (i.e., la suma de los flujos anuales esperados traídos a valor presente). Se redujeron y aumentaron en un punto porcentual la tasa de incremento salarial, que era de 2% anual originalmente, y la tasa de descuento, que era de 6,5% anual, para cada beneficio en el plan. El objetivo era observar la tendencia general, cuantificar las diferencias y ofrecer un razonamiento que justifique los resultados.
