...
## Proyección demográfica de empleados activos

La proyección demográfica de empleados activos se realizó a partir de la base depurada de trabajadores vigentes al inicio del periodo de valoración. Para cada empleado se utilizaron las variables de sexo, fecha de nacimiento, fecha de ingreso, salario mensual, edad al corte, antigüedad, edad de jubilación y probabilidad inicial de muerte. La fecha de corte utilizada fue el 31 de diciembre de 2025.

En primer lugar, se organizó y limpió la base de empleados activos. Se verificó la existencia de identificadores, fechas válidas, sexo correctamente clasificado y salarios positivos. Luego, se calcularon variables derivadas necesarias para el modelo, como la edad al corte, la antigüedad laboral, la edad normal de jubilación y los años restantes hasta la jubilación.
...
Donde (J_{i,t}) representa la salida esperada por jubilación. De esta forma, la transición anual de empleados activos se resumió mediante la relación entre activos al inicio, muertes esperadas, jubilaciones esperadas y activos al cierre.

Finalmente, los resultados individuales se agregaron por año y sexo. Para cada año proyectado se obtuvo la cantidad esperada de activos al inicio, muertes esperadas, jubilaciones esperadas y activos al cierre, separados entre mujeres, hombres y total. Esta estructura permitió analizar la evolución demográfica de la población activa y generar las tablas y gráficos correspondientes del modelo.

## Proyección demográfica y proyección de muertes de pensionados

La proyección demográfica de pensionados se desarrolló a partir del enfoque actuarial clásico de supervivencia presentado por Bowers et al. (1997). Bajo este enfoque, se considera una vida de edad $(x)$ y se modela su tiempo de vida futuro mediante la variable aleatoria $(T_x)$. En el caso discreto, se utiliza la vida futura acotada $(K_x)$, lo que permite expresar probabilidades de supervivencia y fallecimiento en años enteros.
...
En este proyecto se mantuvo esta lógica de supervivencia anual discreta, pero adaptada a la tabla de mortalidad dinámica SP-2015 de SUPEN. Esta tabla permite que la probabilidad de muerte varíe según la edad, el sexo y el año calendario. Por ello, la probabilidad anual de muerte se representó como
...
donde $(L_k^{P_0})$ representa los pensionados iniciales sobrevivientes y $(L_k^{A\to P})$ los empleados activos que se incorporan como pensionados.

Para los pensionados iniciales, la cantidad esperada de vivos al inicio del año $(k)$ se calculó como
...
Para incorporar a los empleados activos que se convierten en pensionados, se utilizó la edad normal de jubilación definida en el proyecto: 65 años para hombres y 63 años para mujeres. Esta condición se expresó como
...
donde $({}*{t-1}p*{x_j})$ representa la probabilidad de supervivencia hasta el inicio del año de riesgo, y $(q_{x_j+t-1})$ corresponde a la probabilidad de fallecimiento durante ese año.

Si el beneficio por muerte de activos se denota por $(B_A)$, el flujo esperado individual para el año $(t)$ fue

$$
FE^{A}*{j,t}=B_A \cdot {}*{t-1}p_{x_j}q_{x_j+t-1},
$$
...
Por su parte, el beneficio por muerte de pensionados presentó un costo nominal esperado de ₡948.234.510,00 y un costo actuarial a valor presente de ₡233.162.744,05. Este resultado corresponde a los pagos esperados asociados a fallecimientos de participantes en condición de pensionados.

Al sumar ambos beneficios de muerte, el valor presente actuarial conjunto fue de ₡291.109.345,41. Este monto refleja el costo actuarial total esperado de los beneficios por fallecimiento, distinguiendo entre la condición activa y pensionada del participante al momento del pago.

En cuanto a las anualidades de pensión, se obtuvo el componente de mayor peso dentro del plan. El costo nominal esperado fue de ₡430.796.400.185,61, mientras que el costo actuarial a valor presente fue de ₡29.634.349.842,37. La magnitud de este resultado se explica porque las anualidades representan pagos periódicos de largo plazo.

Para la suma única de reconocimiento o *Lump Sum*, el costo nominal esperado fue de ₡2.736.349.062,19. Al traer estos pagos a valor presente, el costo actuarial estimado fue de ₡529.153.943,49. Este beneficio tuvo un impacto menor que las anualidades de pensión, pero superior al costo individual de los beneficios de muerte.

Finalmente, al integrar todos los beneficios analizados, se obtuvo un costo nominal esperado total de ₡435.181.851.838,70. El costo actuarial total a valor presente fue de ₡30.454.613.131,27. Este valor representa la estimación global del compromiso económico del plan, considerando los beneficios por muerte de activos, muerte de pensionados, anualidades de pensión y suma única de reconocimiento.
